...
class KanbanView extends TPage
{
	...
	public function __construct()
	{
		...
		$this->kanban->addItemAction('Edita', new TAction(['KanbanAtividadeForm', 'onEdit'], ['register_state' => 'false']), 'far:edit blue');
		$this->kanban->addItemAction('Exclui', new TAction([$this, 'onDeleteAtividade']), 'far:trash-alt red');
