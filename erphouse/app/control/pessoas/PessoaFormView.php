...
class PessoaFormView extends TPage
{
    ...
    public function onEdit($param)
    {
        try
        {
            ...
            $text_created_at  = new TTextDisplay(TDateTime::convertToMask($master_object->created_at, 'yyyy-mm-dd hh:ii:ss', 'dd/mm/yyyy hh:ii:ss'));
            ...
            $panel = new TPanelGroup('Ultimas 5 contas a receber', '#f5f5f5');
