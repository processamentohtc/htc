...
class SystemRoleList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        parent::setActiveRecord('SystemRole');   // defines the active record
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_SystemRole');
        $this->form->setFormTitle(_t('Roles'));
        ...
        $this->form->setData( TSession::getValue('SystemRole_filter_data') );
        ...
        $this->datagrid->addColumn($column_custom);
