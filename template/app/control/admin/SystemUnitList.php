...
class SystemUnitList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('SystemUnitForm', 'onEdit'), ['register_state' => 'false']);
        ...
        $panel->addHeaderActionLink('', new TAction(['SystemUnitForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus');
